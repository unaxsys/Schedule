...
function normalizeCalculationSettingsPayload(input = {}, { partial = false } = {}) {
  ...
  const normalized = {
    ...
    workedMinutesSource: cleanStr(input.workedMinutesSource || CALCULATION_SETTINGS_DEFAULTS.workedMinutesSource),
    shiftResolutionPrimary: cleanStr(input.shiftResolutionPrimary || CALCULATION_SETTINGS_DEFAULTS.shiftResolutionPrimary),
    shiftResolutionFallback: cleanStr(input.shiftResolutionFallback || CALCULATION_SETTINGS_DEFAULTS.shiftResolutionFallback),
    shiftClassificationSource: cleanStr(input.shiftClassificationSource || CALCULATION_SETTINGS_DEFAULTS.shiftClassificationSource),
    allowCodeOnlyFallback: input.allowCodeOnlyFallback === undefined ? CALCULATION_SETTINGS_DEFAULTS.allowCodeOnlyFallback : Boolean(input.allowCodeOnlyFallback),
    legacyCodeFallbackMode: cleanStr(input.legacyCodeFallbackMode || CALCULATION_SETTINGS_DEFAULTS.legacyCodeFallbackMode),
    splitShiftAggregationMode: cleanStr(input.splitShiftAggregationMode || CALCULATION_SETTINGS_DEFAULTS.splitShiftAggregationMode),
    zeroSnapshotForNonWorking: input.zeroSnapshotForNonWorking === undefined ? CALCULATION_SETTINGS_DEFAULTS.zeroSnapshotForNonWorking : Boolean(input.zeroSnapshotForNonWorking),
    workedDayRequiresPositiveMinutes: input.workedDayRequiresPositiveMinutes === undefined ? CALCULATION_SETTINGS_DEFAULTS.workedDayRequiresPositiveMinutes : Boolean(input.workedDayRequiresPositiveMinutes),
    holidayCalculationSource: cleanStr(input.holidayCalculationSource || CALCULATION_SETTINGS_DEFAULTS.holidayCalculationSource),
    weekendCalculationSource: cleanStr(input.weekendCalculationSource || CALCULATION_SETTINGS_DEFAULTS.weekendCalculationSource),
    nightCalculationSource: cleanStr(input.nightCalculationSource || CALCULATION_SETTINGS_DEFAULTS.nightCalculationSource),
    holidayPremiumCoefficient: cleanStr(input.holidayPremiumCoefficient || CALCULATION_SETTINGS_DEFAULTS.holidayPremiumCoefficient),
    weekendPremiumCoefficient: cleanStr(input.weekendPremiumCoefficient || CALCULATION_SETTINGS_DEFAULTS.weekendPremiumCoefficient),
    nightPremiumCoefficient: cleanStr(input.nightPremiumCoefficient || CALCULATION_SETTINGS_DEFAULTS.nightPremiumCoefficient),
    specialHoursOnlyIfWorkMinutesPositive: input.specialHoursOnlyIfWorkMinutesPositive === undefined ? CALCULATION_SETTINGS_DEFAULTS.specialHoursOnlyIfWorkMinutesPositive : Boolean(input.specialHoursOnlyIfWorkMinutesPositive),
    splitByCalendarDate: input.splitByCalendarDate === undefined ? CALCULATION_SETTINGS_DEFAULTS.splitByCalendarDate : Boolean(input.splitByCalendarDate),
    crossMidnightSplitMode: cleanStr(input.crossMidnightSplitMode || CALCULATION_SETTINGS_DEFAULTS.crossMidnightSplitMode),
    payableHoursMode: cleanStr(input.payableHoursMode || CALCULATION_SETTINGS_DEFAULTS.payableHoursMode),
    overtimeMode: cleanStr(input.overtimeMode || CALCULATION_SETTINGS_DEFAULTS.overtimeMode),
    comparisonMode: cleanStr(input.comparisonMode || CALCULATION_SETTINGS_DEFAULTS.comparisonMode),
    includePremiumsInPayable: input.includePremiumsInPayable === undefined ? CALCULATION_SETTINGS_DEFAULTS.includePremiumsInPayable : Boolean(input.includePremiumsInPayable),
    nightConversionMode: cleanStr(input.nightConversionMode || CALCULATION_SETTINGS_DEFAULTS.nightConversionMode),
    enableRuleTrace: input.enableRuleTrace === undefined ? CALCULATION_SETTINGS_DEFAULTS.enableRuleTrace : Boolean(input.enableRuleTrace),
    showAppliedRules: input.showAppliedRules === undefined ? CALCULATION_SETTINGS_DEFAULTS.showAppliedRules : Boolean(input.showAppliedRules),
    showRejectedRules: input.showRejectedRules === undefined ? CALCULATION_SETTINGS_DEFAULTS.showRejectedRules : Boolean(input.showRejectedRules),
    priority: Number.isFinite(Number(input.priority)) ? Number(input.priority) : CALCULATION_SETTINGS_DEFAULTS.priority,
    conflictResolution: cleanStr(input.conflictResolution || CALCULATION_SETTINGS_DEFAULTS.conflictResolution),
